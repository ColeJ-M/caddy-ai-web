...
const styles = {
  ...
  screen: { padding: "16px 16px 20px", minHeight: 700, display: "flex", flexDirection: "column" },
  ...
  choiceGrid: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "8px" },
  choiceCard: { textAlign: "left", padding: "16px 18px", borderRadius: 14, border: "2px solid var(--line)", background: "var(--surface)", fontSize: 15, fontWeight: 500, color: "var(--ink)" },
  ...
  homeCoachNote: { fontSize: 13, color: "var(--ink)", marginTop: 14, lineHeight: 1.5, borderTop: "1px dashed var(--line)", paddingTop: 14 },
